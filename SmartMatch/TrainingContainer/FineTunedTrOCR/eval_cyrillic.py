"""Evaluate a fine-tuned (or base) cyrillic-trocr/trocr-handwritten-cyrillic model."""
...
BASE_MODEL_ID = trocr_base_model("cyrillic")
...
def evaluate(
    ...
    processor_path = model_path if Path(model_path).is_dir() else TOKENIZER_ID
