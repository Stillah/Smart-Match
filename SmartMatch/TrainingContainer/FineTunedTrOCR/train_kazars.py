"""Fine-tune kazars24/trocr-base-handwritten-ru on paired image-text data."""
...
from env_config import default_output_root, joined_data_dir, trocr_base_model

MODEL_ID = trocr_base_model("kazars")
...
if __name__ == "__main__":
    ...
    train(
        ...
        output_dir=default_output_root() / "kazars",
        epochs=1,
        batch_size=4,
    )
